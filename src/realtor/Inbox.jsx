        ...
        <div className="">
            <div className="mt-24 grid grid-cols-2 gap-4">
                {messages.map((message) => (
                    <div className="relative p-8 border border-gray-400 rounded-2xl shadow-md flex flex-col" key={message.id}>
                        <div className="flex-1">
                            <h3 className="text-xl sm:text-lg font-semibold">{message.comments}</h3>
                            ...
                            <p className="mt-4 flex items-baseline ">
                                <span className="text-5xl font-extrabold tracking-tight">{message.name}</span><span className="ml-1 text-xl font-semibold">{message.price}</span>
                            </p>
                            ...
                            <ul role="list" className="mt-6 space-y-6">
                                <li className="flex"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    </svg><span className="ml-3 ">{message.first_name}</span></li>
                                <li className="flex"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                        strokeLinejoin="round" className="flex-shrink-0 w-6 h-6 text-emerald-500" aria-hidden="true">
                                        <polyline points="20 6 9 17 4 12"></polyline>
                                    </svg><span className="ml-3 ">{message.last_name}</span></li>
                                <li className="flex"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                        strokeLinejoin="round" className="flex-shrink-0 w-6 h-6 text-emerald-500" aria-hidden="true">
                                        <polyline points="20 6 9 17 4 12"></polyline>
                                    </svg><span className="ml-3 ">{message.email}</span></li>
                            </ul>
                        </div>
